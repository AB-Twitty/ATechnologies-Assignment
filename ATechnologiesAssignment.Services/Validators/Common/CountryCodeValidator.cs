...
{
    public class CountryCodeValidator : IValidator<CountryCodeDto>
    {
        private readonly IList<string> _validCountryCodes = new List<string>
        {
        ...
        public ValidationResult Validate(CountryCodeDto entity)
        {
            var result = new ValidationResult();

            if (entity.CountryCode.Length != 2 || !_validCountryCodes.Contains(entity.CountryCode))
            {
                result.Errors.Add("CountryCode", "Invalid country code.");
            }
